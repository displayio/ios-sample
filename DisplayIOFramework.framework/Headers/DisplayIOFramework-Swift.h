...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DisplayIOFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

typedef SWIFT_ENUM(NSInteger, ConsentState) {
  ConsentStateUnknown = 0,
  ConsentStateNot_eea_user = 1,
  ConsentStateConsent_personalized_ads = 2,
  ConsentStateConsent_non_personalized_ads = 3,
};

@protocol DioEventDelegate;
@class UIViewController;

SWIFT_CLASS("_TtC18DisplayIOFramework13DioController")
@interface DioController : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull sdkVersion;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DioController * _Nonnull sharedInstance;)
+ (DioController * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) id <DioEventDelegate> _Nullable eventDelegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (void)initializeWithAppId:(NSString * _Nonnull)appId;
- (void)showAdWithPresentingViewController:(UIViewController * _Nonnull)presentingViewController placementId:(NSString * _Nonnull)placementId;
- (NSDictionary<NSString *, id> * _Nonnull)getConsentData SWIFT_WARN_UNUSED_RESULT;
- (enum ConsentState)getConsentState SWIFT_WARN_UNUSED_RESULT;
- (void)updateContestStateWithState:(enum ConsentState)state wording:(NSString * _Nonnull)wording obtainedTimestampInSec:(int64_t)obtainedTimestampInSec;
@end


SWIFT_PROTOCOL("_TtP18DisplayIOFramework16DioEventDelegate_")
@protocol DioEventDelegate
- (void)onInit:(NSArray<NSString *> * _Nonnull)placementIds;
- (void)onNoAds:(NSString * _Nonnull)placementId;
- (void)onAdReady:(NSString * _Nonnull)placementId;
- (void)onAdShown:(NSString * _Nonnull)placementId;
- (void)onAdFailedToShow:(NSString * _Nonnull)placementId;
- (void)onAdClose:(NSString * _Nonnull)placementId;
- (void)onAdClick:(NSString * _Nonnull)placementId;
@end
...
SWIFT_CLASS("_TtC18DisplayIOFramework15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(DisplayIOFramework)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DisplayIOFramework)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DisplayIOFramework)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DisplayIOFramework)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(DisplayIOFramework)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC18DisplayIOFramework12TaskDelegate")
